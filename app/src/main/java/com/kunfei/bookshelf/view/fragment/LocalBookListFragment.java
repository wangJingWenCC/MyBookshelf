...
public class LocalBookListFragment extends MBaseFragment<BookListContract.Presenter> implements BookListContract.View {
    ...
    private LocalCallbackValue callbackValue;
    ...
    protected void initData() {
        callbackValue = (LocalCallbackValue) getActivity();
        bookPx = preferences.getString(getString(R.string.pk_bookshelf_px), "0");
        isRecreate = callbackValue != null && callbackValue.isLocalRecreate();
    }
    ...
    protected void bindEvent() {
        ...
        itemTouchCallback.setViewPager(callbackValue.getLocalViewPager());
        if (bookPx.equals("2")) {
    ...
    public interface LocalCallbackValue {
        boolean isLocalRecreate();

        int getLocalGroup();

        ViewPager getLocalViewPager();
    }
